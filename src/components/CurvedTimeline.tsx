...
const timelineData = [
  { id: 1, title: "Full Paper Submission", date: "10 Dec, 2025", description: "Submit research papers.", icon: Calendar },
  { id: 2, title: "Acceptance Notification", date: "10 Jan, 2026", description: "Notification of accepted papers.", icon: Award },
